...
-- Listage des données de la table finalprojectapp.custom_itinerary : ~0 rows (environ)
...
-- Listage des données de la table finalprojectapp.messenger_messages : ~0 rows (environ)
...
-- Listage des données de la table finalprojectapp.place : ~4 rows (environ)
INSERT INTO `place` (`id`, `name`, `address`, `city`, `zipcode`, `opening_hours`, `website`, `phone_number`, `description`, `latitude`, `longitude`, `is_verified`, `type_id`) VALUES
	(9, 'Auberge du Cheval Blanc', '20 Rue de Rouffach', 'Westhalten', 68250, 'Lundi :\r\nMardi :\r\nMercredi :\r\nJeudi :\r\nVendredi :\r\nSamedi :\r\nDimanche :', 'www.restaurant-koehler.com', '0389470116', 'Installée dans un village pittoresque entouré de vignobles, cette charmante auberge occupe un édifice traditionnel alsacien à colombages doté d\'une annexe moderne. Elle se trouve à 7 km de l\'office de tourisme de Rouffach et à 21 km du centre-ville de Colmar.\r\nAménagées dans l\'annexe, les 12 chambres sobres avec vue sur le jardin sont équipées d\'une salle de bain attenante, d\'une télévision à écran plat et du Wi-Fi gratuit.\r\nLe restaurant raffiné, situé dans le bâtiment principal, propose un menu de saison avec mets et vins de la région. L\'établissement possède en outre une salle de réunion simple.', 47.95476500, 7.26283300, 1, 3),
	(10, 'La Fourchette des Ducs', '6 rue de la Gare', 'Obernai', 67210, '19h-21h', 'http://www.lafourchettedesducs.com', '0388483338', 'Gastronomie créative du terroir à cette table raffinée avec salons d\'été et d\'hiver et terrasse ombragée.', 48.46215800, 7.48822800, 1, 1),
	(11, 'Hôtel Relais du Vignoble', '33 Rue des Forgerons', 'Gueberschwihr', 68420, 'Lundi :\r\nMardi :\r\nMercredi :\r\nJeudi :\r\nVendredi :\r\nSamedi :\r\nDimanche :', 'http://www.relaisduvignoble.com', '0389492222', 'Niché dans un vignoble, cet hôtel à l\'ambiance décontractée se trouve à 10 km de l\'Alsace Golf Links et à 12 km du musée Unterlinden.\r\nLes chambres, à la décoration chaleureuse et personnalisée, ont vue sur le vignoble. Elles comprennent le Wi-Fi gratuit, une télévision à écran plat et une salle de bain attenante avec douche ou baignoire.\r\nLe petit-déjeuner est servi (moyennant un supplément) dans un restaurant convivial qui possède une terrasse. Un salon télé, un centre d\'affaires et un parking gratuit sont également à disposition.', 48.00428000, 7.27856000, 1, 2),
	(12, 'Musée National de l\'Automobile', '17 rue de la Mertzau', 'Mulhouse', 68100, '10h-18h', 'http://www.musee-automobile.fr', '0389332323', 'Le musée national de l\'Automobile - Collection Schlumpf est un musée situé à Mulhouse, dans le quartier du Péricentre, et qui abrite la plus importante collection de voitures du monde. On y trouve en effet plus de 500 véhicules - dont la célèbre collection Schlumpf des frères Schlumpf.', 47.76246600, 7.33661300, 1, 4);
...
-- Listage des données de la table finalprojectapp.place_companion : ~6 rows (environ)
