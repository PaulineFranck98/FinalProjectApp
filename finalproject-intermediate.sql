...
-- Listage des données de la table finalprojectapp.city : ~0 rows (environ)
...
-- Listage des données de la table finalprojectapp.custom_itinerary_city : ~0 rows (environ)
