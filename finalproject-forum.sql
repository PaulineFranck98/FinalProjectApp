...
-- Listage des données de la table finalprojectapp.custom_itinerary : ~3 rows (environ)
...
-- Listage des données de la table finalprojectapp.custom_itinerary_city : ~7 rows (environ)
...
INSERT INTO `post` (`id`, `user_id`, `place_id`, `title`, `content`, `image`, `creation_date`, `is_closed`) VALUES
	...
	(3, 1, 10, 'Une soirée inoubliable', 'J\'ai passé une soirée inoubliable dans ce restaurant qui allie finesse et  robustesse dans ses plats absolument magnifiques..', 'repas-fourchette-ducs-664654e453d6a.webp', '2024-05-16 18:48:04', 0),
...
-- Listage des données de la table finalprojectapp.user : ~3 rows (environ)
