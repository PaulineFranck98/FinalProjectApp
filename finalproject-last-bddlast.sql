...
-- Listage des données de la table finalprojectapp.commentary : ~3 rows (environ)
INSERT INTO `commentary` (`id`, `user_id`, `post_id`, `content`, `creation_date`) VALUES
	(1, 1, 1, 'Super post, la photo est très sympa', '2024-05-16 16:39:41'),
...
-- Listage des données de la table finalprojectapp.custom_itinerary : ~6 rows (environ)
INSERT INTO `custom_itinerary` (`id`, `user_id`, `name`, `creation_date`, `departure_id`, `arrival_id`) VALUES
	(1, 1, 'Idée itinéraire', '2024-05-15 20:22:57', 4, 3),
	(4, 1, 'Mon itinéraire', '2024-05-15 20:21:34', 4, 6),
	(5, 1, 'super itinéraire', '2024-05-15 20:20:54', 6, 4),
	(6, 1, 'Tour des caves à vin', '2024-05-31 13:21:49', 4, 6),
	(7, 1, 'Choucroute Tour', '2024-05-31 13:24:57', 5, 4),
	(8, 1, 'Mon itinéraire2', '2024-05-31 13:29:05', 5, 6);
...
-- Listage des données de la table finalprojectapp.custom_itinerary_city : ~12 rows (environ)
...
-- Listage des données de la table finalprojectapp.messenger_messages : ~6 rows (environ)
...
-- Listage des données de la table finalprojectapp.rating : ~3 rows (environ)
INSERT INTO `rating` (`id`, `place_id`, `user_id`, `rating`, `comment`, `rating_date`) VALUES
	...
	(3, 9, 1, 5, 'Super expérience !!', '2024-05-31 13:41:15');
...
-- Listage des données de la table finalprojectapp.reset_password_request : ~1 rows (environ)
INSERT INTO `reset_password_request` (`id`, `user_id`, `selector`, `hashed_token`, `requested_at`, `expires_at`) VALUES
	...
	(4, 2, 'v98JlRYKMOuNXdbFQkEa', 'Wq2K/22fzXFV6+1wOauPtZeghtwuumAXrrAwBUQnXuI=', '2024-05-22 09:09:38', '2024-05-22 10:09:38');
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `is_verified`, `username`, `profile_picture`, `is_banned`) VALUES
	...
	(4, 'stephane@exemple.com', '[]', '$2y$13$J7H.MnRSsprveDNYGoc1yOfiw9wdWNbzwUhFB.UkocM3q8iLpQbJO', 0, 'stephane', 'pexels-adrien-stachowiak-170983955-13858979-6659e3c21c65c.jpg', 0);
