...
-- Listage des données de la table finalprojectapp.rating : ~0 rows (environ)
...
-- Listage des données de la table finalprojectapp.theme : ~0 rows (environ)
...
-- Listage des données de la table finalprojectapp.type : ~0 rows (environ)
...
-- Listage des données de la table finalprojectapp.user : ~0 rows (environ)
