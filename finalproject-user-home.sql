...
-- Listage des données de la table finalprojectapp.messenger_messages : ~17 rows (environ)
...
-- Listage des données de la table finalprojectapp.reset_password_request : ~4 rows (environ)
