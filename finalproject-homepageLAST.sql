...
-- Listage des données de la table finalprojectapp.custom_itinerary_city : ~9 rows (environ)
...
-- Listage des données de la table finalprojectapp.custom_itinerary_place_city : ~15 rows (environ)
...
-- Listage des données de la table finalprojectapp.favorite : ~1 rows (environ)
